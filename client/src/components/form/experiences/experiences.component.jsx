...
const Experiences = props => {
    ...
    for (let i = 0; i < nFields; i++) {
      ...
      fieldArray.push({
        ...
        value: {
          ...
          experience: props.fields[i].experience,
  ...
  const fieldReturn = Fields => {
    ...
    props.stateChange("Experiences", fieldsWithoutId);
  }
  ...
  return (
    <Fragment>
      ...
      />
      <div className="experiences-add-button">
    ...
    <div className="item">
      <ExpansionPanel >
          ...
          <ExpansionPanelDetails>
            <div className="experiences-fields">
            <GreenCheckbox checked={props.value.value.appear} onChange={e => checkChange(props.value.id, e)}/> In resume
              <TextField className="experiences-experience" label="Experience" variant="outlined" value={props.value.value.experience}
                onChange={(e) => stateChange(props.value.id, "experience", e.target.value)}/>
              <TextField className="experiences-duration" label="Duration" variant="outlined" value={props.value.value.duration}
                onChange={(e) => stateChange(props.value.id, "duration", e.target.value)}/>
              <TextField className="experiences-guide" label="Guide" variant="outlined" value={props.value.value.guide}
                onChange={(e) => stateChange(props.value.id, "guide", e.target.value)}/>
              <TextField className="experiences-description" label="Description" multiline variant="outlined" value={props.value.value.description}
                onChange={(e) => stateChange(props.value.id, "description", e.target.value)}/>
              <div className="experiences-delete">
